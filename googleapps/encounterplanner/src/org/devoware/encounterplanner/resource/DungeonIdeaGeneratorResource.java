...
@Path("dungeon-idea-generator")
public class DungeonIdeaGeneratorResource {
    ...
    public Response get() {
		try {
            DungeonIdea dungeonIdea = service.generateDungeonIdea();
	        return Response.ok(dungeonIdea).build();
		} catch (Throwable t) {
