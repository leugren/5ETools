...
public class Npcs {
	...
	public static final ValueSet NAME_GENERATOR_BEGINNING = ValueSet.newValueSet()
			.with("A")
			.with("Be")
			.with("De")
			.with("El")
	...
	public static final ValueSet NAME_GENERATOR_MIDDLE = ValueSet.newValueSet()
			.with("bar")
			.with("ched")
			.with("dell")
			.with("far")
	...
	public static final ValueSet NAME_GENERATOR_END = ValueSet.newValueSet()
			.with("a")
			.with("ac")
			.with("ai")
			.with("al")
	...
	public static final FormattedValue NAME_GENERATOR = newFormattedValue("%s%s%s", 
			NAME_GENERATOR_BEGINNING, 
			NAME_GENERATOR_MIDDLE, 
			NAME_GENERATOR_END);
