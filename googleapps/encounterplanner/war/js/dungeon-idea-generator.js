...
DEVOWARE.encounterPlanner = (function () {
	...
	var handleSuccess = function (json) {
		...
		generateStat($("#stats"), "Location", json.location);
		generateStat($("#stats"), "Creator", json.creator);
		generateStat($("#stats"), "Purpose", json.purpose);
		generateStat($("#stats"), "History", json.history);
	...
	var generate = function () {
		var url = "/api/dungeon-idea-generator?var=" + (new Date()).getTime();
		url = encodeURI(url);
