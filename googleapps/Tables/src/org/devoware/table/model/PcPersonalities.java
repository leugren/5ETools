...
public class PcPersonalities {
	...
	public static final RandomizableStringSource ACOLYTE_BONDS = newValueRangeMap(D6)
			...
			.with(3, "I owe me life to the priest who took me in when my parents died.")
	...
	public static final IdealSet GUILD_ARTISAN_IDEALS = newIdealSet()
			...
			.with(EVIL, "Greed. I'm only in it for the money. (Evil)")
	...
	public static final RandomizableStringSource URCHIN_BONDS = newValueRangeMap(D6)
			...
			.with(5, "I escaped my life of povrty by robbing an important person, and I'm wanted for it.")
	...
	public static final ValueSet ALL_TRAITS = ValueSet.newValueSet()
			.with(ACOLYTE_TRAITS.toValueSet())
			.with(CHARLATAN_TRAITS.toValueSet())
			.with(CRIMINAL_TRAITS.toValueSet())
			.with(ENTERTAINER_TRAITS.toValueSet())
			.with(FOLK_HERO_TRAITS.toValueSet())
			.with(GUILD_ARTISAN_TRAITS.toValueSet())
			.with(HERMIT_TRAITS.toValueSet())
			.with(NOBLE_TRAITS.toValueSet())
			.with(OUTLANDER_TRAITS.toValueSet())
			.with(SAGE_TRAITS.toValueSet())
			.with(SAILOR_TRAITS.toValueSet())
			.with(SOLDIER_TRAITS.toValueSet())
			.with(URCHIN_TRAITS.toValueSet())
			.build();

	public static final ValueSet ALL_IDEALS = ValueSet.newValueSet()
			.with(ACOLYTE_IDEALS.toValueSet())
			.with(CHARLATAN_IDEALS.toValueSet())
			.with(CRIMINAL_IDEALS.toValueSet())
			.with(ENTERTAINER_IDEALS.toValueSet())
			.with(FOLK_HERO_IDEALS.toValueSet())
			.with(GUILD_ARTISAN_IDEALS.toValueSet())
			.with(HERMIT_IDEALS.toValueSet())
			.with(NOBLE_IDEALS.toValueSet())
			.with(OUTLANDER_IDEALS.toValueSet())
			.with(SAGE_IDEALS.toValueSet())
			.with(SAILOR_IDEALS.toValueSet())
			.with(SOLDIER_IDEALS.toValueSet())
			.with(URCHIN_IDEALS.toValueSet())
			.build();

	public static final ValueSet ALL_BONDS = ValueSet.newValueSet()
			.with(ACOLYTE_BONDS.toValueSet())
			.with(CHARLATAN_BONDS.toValueSet())
			.with(CRIMINAL_BONDS.toValueSet())
			.with(ENTERTAINER_BONDS.toValueSet())
			.with(FOLK_HERO_BONDS.toValueSet())
			.with(GUILD_ARTISAN_BONDS.toValueSet())
			.with(HERMIT_BONDS.toValueSet())
			.with(NOBLE_BONDS.toValueSet())
			.with(OUTLANDER_BONDS.toValueSet())
			.with(SAGE_BONDS.toValueSet())
			.with(SAILOR_BONDS.toValueSet())
			.with(SOLDIER_BONDS.toValueSet())
			.with(URCHIN_BONDS.toValueSet())
			.build();

	public static final ValueSet ALL_FLAWS = ValueSet.newValueSet()
			.with(ACOLYTE_FLAWS.toValueSet())
			.with(CHARLATAN_FLAWS.toValueSet())
			.with(CRIMINAL_FLAWS.toValueSet())
			.with(ENTERTAINER_FLAWS.toValueSet())
			.with(FOLK_HERO_FLAWS.toValueSet())
			.with(GUILD_ARTISAN_FLAWS.toValueSet())
			.with(HERMIT_FLAWS.toValueSet())
			.with(NOBLE_FLAWS.toValueSet())
			.with(OUTLANDER_FLAWS.toValueSet())
			.with(SAGE_FLAWS.toValueSet())
			.with(SAILOR_FLAWS.toValueSet())
			.with(SOLDIER_FLAWS.toValueSet())
			.with(URCHIN_FLAWS.toValueSet())
			.build();
}
